...
class BookListCategoryAdapter(val bookListCategory:ArrayList<Book>):RecyclerView.Adapter<BookListCategoryAdapter.SpecificCategoryHolder>() {
    class SpecificCategoryHolder(var view: View):RecyclerView.ViewHolder(view)
